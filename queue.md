...
Shorter objects than the books above, and they change the format: the essay
supplies the mechanism, the narrator supplies the worked case. Three shapes —
single deep read, the duel (two texts answering one question incompatibly), and
the constellation (three short papers staged as rediscovery).

- [x] The Tyranny of Structurelessness (Jo Freeman, 1970–73) — done as 012,
...
- [ ] Weinberg, "Science and Trans-Science" (Minerva 10:209–222, 1972).
  ...
  The bicycle-shed committee where the item nobody could have seen passes
  through in two and a half minutes.
...
Second tier: Hayek's "The Use of Knowledge in Society" (1945) staged against
Beer and Cybersyn from 003–005 (risks re-treading the Davies series) ·
Lindblom's "The Science of 'Muddling Through'" (1959) as the pre-emptive
rebuttal to Seeing Like a State · Conway's "How Do Committees Invent?" (1968),
too thin alone, constellation material with Parkinson · Illich's "Disabling
